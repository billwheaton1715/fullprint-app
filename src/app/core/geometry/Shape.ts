...
export abstract class Shape {
  /** Optional appearance — carried through translate/rotate/scale. */
  fillStyle?: string;
  strokeStyle?: string;
  lineWidth?: number;

  /** Copy appearance properties from this shape onto a newly created instance. */
  protected copyStyleTo(target: Shape): void {
    if (this.fillStyle   !== undefined) target.fillStyle   = this.fillStyle;
    if (this.strokeStyle !== undefined) target.strokeStyle = this.strokeStyle;
    if (this.lineWidth   !== undefined) target.lineWidth   = this.lineWidth;
  }
